...
try :
    from audio .method import spectrum_fingerprint 
except Exception :
    spectrum_fingerprint =None 
try :

    from audio .method import LSH_deal_with_photo as lsh_utils 
except Exception :
    lsh_utils =None 
try :
    from audio .method import precomputed_utils 
except Exception :
    precomputed_utils =None 
